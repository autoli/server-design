#ifndef __AUTOLI_DS_ROARING_BITMAP_H__
#define __AUTOLI_DS_ROARING_BITMAP_H__
...
public:
    ...
    void writeTo(autoli::ByteArray::ptr ba) const;
    bool readFrom(autoli::ByteArray::ptr ba);
