#ifndef __AUTOLI_MODULE_H__
#define __AUTOLI_MODULE_H__

#include "autoli/stream.h"
...
public:
    ...
    virtual bool onConnect(autoli::Stream::ptr stream);
    virtual bool onDisconnect(autoli::Stream::ptr stream);
    
    virtual bool onServerReady();
    virtual bool onServerUp();

    virtual bool handleRequest(autoli::Message::ptr req
                               ,autoli::Message::ptr rsp
                               ,autoli::Stream::ptr stream);
    virtual bool handleNotify(autoli::Message::ptr notify
                              ,autoli::Stream::ptr stream);
...
public:
    ...
    virtual bool handleRockRequest(autoli::RockRequest::ptr request
                        ...
                        ,autoli::RockStream::ptr stream) = 0;
...
typedef autoli::Singleton<ModuleManager> ModuleMgr;
