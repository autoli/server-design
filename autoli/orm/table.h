#ifndef __AUTOLI_ORM_TABLE_H__
#define __AUTOLI_ORM_TABLE_H__
...
private:
    ...
    std::string m_dbclass = "autoli::IDB";
    std::string m_queryclass = "autoli::IDB";
    std::string m_updateclass = "autoli::IDB";
