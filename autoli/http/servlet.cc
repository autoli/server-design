...
int32_t FunctionServlet::handle(autoli::http::HttpRequest::ptr request
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("autoli/1.0"));
}

int32_t ServletDispatch::handle(autoli::http::HttpRequest::ptr request
               , autoli::http::HttpResponse::ptr response
               , autoli::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(autoli::http::HttpRequest::ptr request
                   , autoli::http::HttpResponse::ptr response
                   , autoli::http::HttpSession::ptr session) {
    response->setStatus(autoli::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "autoli/1.0.0");
