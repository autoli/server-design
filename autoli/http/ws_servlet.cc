...
int32_t FunctionWSServlet::onConnect(autoli::http::HttpRequest::ptr header
...
int32_t FunctionWSServlet::onClose(autoli::http::HttpRequest::ptr header
                                     ,autoli::http::WSSession::ptr session) {
    if(m_onClose) {
...
int32_t FunctionWSServlet::handle(autoli::http::HttpRequest::ptr header
