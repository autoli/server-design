#ifndef __AUTOLI_HTTP_WS_SESSION_H__
#define __AUTOLI_HTTP_WS_SESSION_H__

#include "autoli/config.h"
#include "autoli/http/http_session.h"
#include <stdint.h>
...
extern autoli::ConfigVar<uint32_t>::ptr g_websocket_message_max_size;
