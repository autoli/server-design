 ...
 */
#ifndef __AUTOLI_HTTP_SERVLET_H__
#define __AUTOLI_HTTP_SERVLET_H__
...
public:
    ...
    virtual int32_t handle(autoli::http::HttpRequest::ptr request
                   ...
                   , autoli::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (autoli::http::HttpRequest::ptr request
                   , autoli::http::HttpResponse::ptr response
                   , autoli::http::HttpSession::ptr session)> callback;
