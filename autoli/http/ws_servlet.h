...
public:
    ...
    virtual int32_t onConnect(autoli::http::HttpRequest::ptr header
                              ,autoli::http::WSSession::ptr session) = 0;
    virtual int32_t onClose(autoli::http::HttpRequest::ptr header
                             ,autoli::http::WSSession::ptr session) = 0;
    virtual int32_t handle(autoli::http::HttpRequest::ptr header
...
public:
    ...
    typedef std::function<int32_t (autoli::http::HttpRequest::ptr header
                              ,autoli::http::WSSession::ptr session)> on_connect_cb;
    typedef std::function<int32_t (autoli::http::HttpRequest::ptr header
                             ,autoli::http::WSSession::ptr session)> on_close_cb; 
    typedef std::function<int32_t (autoli::http::HttpRequest::ptr header
                           ,autoli::http::WSFrameMessage::ptr msg
                           ,autoli::http::WSSession::ptr session)> callback;
    ...
    virtual int32_t onConnect(autoli::http::HttpRequest::ptr header
                              ,autoli::http::WSSession::ptr session) override;
    virtual int32_t onClose(autoli::http::HttpRequest::ptr header
                             ,autoli::http::WSSession::ptr session) override;
    virtual int32_t handle(autoli::http::HttpRequest::ptr header
                           ,autoli::http::WSFrameMessage::ptr msg
