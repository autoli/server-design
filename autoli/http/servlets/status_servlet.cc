...
// int32_t StatusServlet::handle(autoli::http::HttpRequest::ptr request
...
//     std::stringstream ss;
//     ss << "===================================================" << std::endl;
//     XX("server_version") << "autoli/1.0.0" << std::endl;
...
//     ss << "===================================================" << std::endl;
//     XX("fibers") << autoli::Fiber::TotalFibers() << std::endl;
//     ss << "===================================================" << std::endl;
//     ss << "<Logger>" << std::endl;
//     ss << autoli::LoggerMgr::GetInstance()->toYamlString() << std::endl;
//     ss << "===================================================" << std::endl;
//     ss << "<Woker>" << std::endl;
//     autoli::WorkerMgr::GetInstance()->dump(ss) << std::endl;

//     std::map<std::string, std::vector<TcpServer::ptr> > servers;
//     autoli::Application::GetInstance()->listAllServer(servers);
//     ss << "===================================================" << std::endl;
...
//             }
//             if(!hs) {
//                 hs = std::dynamic_pointer_cast<autoli::http::HttpServer>(*iit);
//             }
