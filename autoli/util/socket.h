 ...
 */
#ifndef __AUTOLI_SOCKET_H__
#define __AUTOLI_SOCKET_H__
...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(autoli::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(autoli::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(autoli::Address::ptr address);
