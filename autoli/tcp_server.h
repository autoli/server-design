 ...
 */
#ifndef __AUTOLI_TCP_SERVER_H__
#define __AUTOLI_TCP_SERVER_H__
...
public:
     ...
     */
    TcpServer(autoli::IOManager* worker = autoli::IOManager::GetThis()
              ,autoli::IOManager* io_woker = autoli::IOManager::GetThis()
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(autoli::Address::ptr addr, bool ssl = false);
