#ifndef __AUTOLI_ROCK_ROCK_STREAM_H__
#define __AUTOLI_ROCK_ROCK_STREAM_H__

#include "autoli/streams/async_socket_stream.h"
#include "rock_protocol.h"
#include "autoli/streams/load_balance.h"
...
class RockStream : public autoli::AsyncSocketStream {
public:
    typedef std::shared_ptr<RockStream> ptr;
    typedef std::function<bool(autoli::RockRequest::ptr
                               ,autoli::RockResponse::ptr
                               ,autoli::RockStream::ptr)> request_handler;
    typedef std::function<bool(autoli::RockNotify::ptr
                               ,autoli::RockStream::ptr)> notify_handler;
...
protected:
    ...
    void handleRequest(autoli::RockRequest::ptr req);
    void handleNotify(autoli::RockNotify::ptr nty);
private:
...
public:
    ...
    RockConnection();
    bool connect(autoli::Address::ptr addr);
};
