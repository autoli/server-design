#ifndef __AUTOLI_STREAMS_ASYNC_SOCKET_STREAM_H__
#define __AUTOLI_STREAMS_ASYNC_SOCKET_STREAM_H__
...
public:
    void setWorker(autoli::IOManager* v) { m_worker = v;}
    autoli::IOManager* getWorker() const { return m_worker;}

    void setIOManager(autoli::IOManager* v) { m_iomanager = v;}
    autoli::IOManager* getIOManager() const { return m_iomanager;}
...
protected:
    ...
    bool waitFiber();
protected:
    autoli::FiberSemaphore m_sem;
    autoli::FiberSemaphore m_waitSem;
    ...
    autoli::IOManager* m_iomanager;
    autoli::IOManager* m_worker;
