#ifndef __AUTOLI_DB_MYSQL_H__
#define __AUTOLI_DB_MYSQL_H__
...
public:
    ...
    autoli::IStmt::ptr prepare(const std::string& sql) override;
...
class MySQLManager {
public:
    typedef autoli::Mutex MutexType;
...
typedef autoli::Singleton<MySQLManager> MySQLMgr;
